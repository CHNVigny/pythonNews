...
if __name__ == "__main__":
    category = "social"
    urls = ["http://rss.sina.com.cn/news/society/focus15.xml", "http://news.baidu.com/n?cmd=1&class=socianews&tn=rss", "http://news.baidu.com/n?cmd=4&class=socianews&tn=rss", "http://news.qq.com/newssh/rss_newssh.xml"]
