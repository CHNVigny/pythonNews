...
if __name__ == "__main__":
    category = "tech"
    urls = ["http://rss.sina.com.cn/news/allnews/tech.xml", "http://rss.huanqiu.com/tech/digi.xml", "http://rss.huanqiu.com/tech/news.xml", "http://news.baidu.com/n?cmd=1&class=technnews&tn=rss", "http://news.baidu.com/n?cmd=4&class=technnews&tn=rss", "http://n.rss.qq.com/rss/tech_rss.php"]
